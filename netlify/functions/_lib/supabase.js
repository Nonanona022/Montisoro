...
/* Fetch one calculator submission by id (admin regenerate / resend). */
...
module.exports = { insertPageView, listPageViews, insertSubmission, uploadPdf, listPdfVersions, patchSubmission, listSubmissions, getSubmission, insertFormSubmission, patchFormSubmission, signedPdfUrl, getSiteContent, setSiteContent, listFormSubmissions, logDeliveryFailure, listDeliveryFailures, resolveFailure, deleteRecord, insertLead, listLeads, patchLead, deleteLead, listAudit, insertAudit, getUserByEmail, touchUserLogin, listUsers, upsertUser, setUserPassword, insertContentVersion, listContentVersions, getContentVersion, insertEvent, insertWebVital, listEvents, listWebVitals, upsertDailyMetric, listDailyMetrics, getGscConnection, setGscConnection, clearGscConnection, isConfigured: () => !!(URL && KEY) };
